...
export const getConversations = () => {
    ...
    conversations?.forEach((conversation:any) => {
        ...
        conversationElement.innerHTML = '<div class="ant-card ant-card-bordered" style="width: 45vh;"><div class="ant-card-head"><div class="ant-card-head-wrapper"><div class="ant-card-head-title">Conversation: ' + conversation.id + '</div></div></div><div class="ant-card-body"><div id="' + conversation.id + '-messages" class="sc-llJcti fphRZl" style="height: 200px; overflow: scroll;"></div><div class="sc-llJcti fphRZl" style="padding-top:10px"><span class="ant-input-group"><textarea rows="2" id="' + conversation.id + '-input" class="ant-input"></textarea><button type="button" class="ant-btn ant-btn-primary" style="width: 100%;" id="'+ conversation.id + '"><span>Send</span></button></span></div></div></div>'
